...
tk.Label(app, text="CSV File:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
csv_path_entry = tk.Entry(app, width=50)
csv_path_entry.grid(row=0, column=1, padx=10, pady=5, sticky="w")
browse_button = tk.Button(app, text="Browse", command=load_csv)
browse_button.grid(row=0, column=2, padx=10, pady=5, sticky="w")

tk.Label(app, text="Threshold (microseconds):").grid(row=1, column=0, padx=10, pady=5, sticky="w")
...
regular_stats_label = tk.Label(app, text="", justify="left", anchor="w")
regular_stats_label.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky="w")

threshold_stats_label = tk.Label(app, text="", justify="left", anchor="w")
threshold_stats_label.grid(row=3, column=2, columnspan=2, padx=10, pady=10, sticky="w")
